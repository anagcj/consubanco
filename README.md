...
El proyecto **ConsuBanco Investment API** es una aplicación desarrollada en **Java Spring Boot** para exponer un servicio en el cual se puedan dar de alta un producto de inversión con su respectivo isr y plan de interes, asi mismo se expone otro servicio para clientes y las sucursales del banco. Proporciona una API REST para gestionar datos sobre productos de inversión con su respectivo ISR y planes de interes asi mismo los clientes y sucursales incluyendo la creación, actualización, consulta y eliminación de estos datos.
